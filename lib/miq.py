...
class MakeItQuote:
    ...
    def _enhance_background(self, background: Image.Image, style: Dict) -> Image.Image:
        ...
        background = ImageEnhance.Color(
            background).enhance(1.3)  # Adjust saturation
    ...
    def create_quote(self,
        ...
        if isinstance(style, str):
            style_settings = self.style_presets.get(
        ...
        try:
            quote_font, adjusted_font_size = self._adjust_font_size(
                quote, font_path, output_size[0] - 100, output_size[1] - 200, font_size)
        ...
        credit_position = (width - credit_width - 20,
                           height - credit_font_size - 20)
